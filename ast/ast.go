...
// creates a buffer and writes the return value of each statement's String()
...
type InfixExpression struct {
	Token    token.Token // the token of the infix operator eg. +
	Operator string
	Left     Expression
	Right    Expression
}
...
func (num *IntegerLiteral) expressionNode()      {}
